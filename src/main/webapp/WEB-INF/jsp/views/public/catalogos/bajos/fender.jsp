...
<div class="container justify-content-center text-center">
    ...
    <img src="${pageContext.request.contextPath}/assets/img/catalogos/bajos/fender/fender.png" class="d-block mx-auto p-3" alt="logo fender bajos">
    <p >Fender es la marca que revolucionó el bajo con el Precision Bass, el primer bajo eléctrico sólido producido en masa. Conocida por su sonido grueso y su mástil cómodo, Fender sigue siendo el estándar en géneros como el rock, funk, jazz y blues, ofreciendo modelos icónicos como el Precision y el Jazz Bass.</p>
</div>
            ...
            <c:otherwise>
                <div class="col-12">
                    <div class="alert alert-info text-center" role="alert">
                        No hay bajos Fender disponibles en este momento.
                    </div>
                </div>
            </c:otherwise>
        </c:choose>
