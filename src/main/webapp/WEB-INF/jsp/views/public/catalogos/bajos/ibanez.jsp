...
<div class="container justify-content-center text-center">
    ...
    <img src="${pageContext.request.contextPath}/assets/img/catalogos/bajos/ibanez/ibanez.png" class="d-block mx-auto p-3" alt="logo ibanez" style="max-width: 50%;">
    <p>Ibanez es una marca japonesa con más de medio siglo de historia en la fabricación de instrumentos. Reconocida mundialmente por su innovación y calidad, Ibanez revolucionó el mundo del bajo eléctrico ofreciendo diseños ergonómicos, sonido potente y gran versatilidad. Desde modelos clásicos hasta líneas modernas como Soundgear (SR) y BTB, sus bajos se han convertido en favoritos de músicos de todos los géneros gracias a su comodidad, fiabilidad y tono inconfundible.</p>
</div>
            ...
            <c:otherwise>
                <div class="col-12">
                    <div class="alert alert-info text-center" role="alert">
                        No hay bajos Ibanez disponibles en este momento.
                    </div>
                </div>
            </c:otherwise>
        </c:choose>
