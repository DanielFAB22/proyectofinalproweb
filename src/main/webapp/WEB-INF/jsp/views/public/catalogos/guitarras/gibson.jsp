...
<div class="container justify-content-center text-center">
    <img src="${pageContext.request.contextPath}/assets/img/catalogos/guitarras/gibson/gibson.png" class="d-block mx-auto p-3 w-50 h-25" alt="logo gibson">
    <p>Gibson es una de las marcas más prestigiosas en la historia de la guitarra, reconocida por sus modelos icónicos que definieron el sonido del rock, blues y jazz durante más de un siglo.</p>
    <p>La compañía fue fundada en 1902 por Orville Gibson en Kalamazoo, Michigan, inicialmente fabricando mandolinas y guitarras acústicas. En 1952 presentó la Les Paul, su modelo estrella creado en colaboración con el guitarrista Les Paul, que se convirtió en un clásico del rock. Modelos como la SG, la Flying V y la Explorer marcaron nuevas generaciones de músicos.</p>
</div>
