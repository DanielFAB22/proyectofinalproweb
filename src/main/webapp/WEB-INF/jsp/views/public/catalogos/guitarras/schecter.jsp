...
<div class="container justify-content-center text-center">
    ...
    <img src="${pageContext.request.contextPath}/assets/img/catalogos/guitarras/schecter/schecter.png" class="d-block mx-auto p-3" alt="logo schecter" style="max-width: 50%;">
            ...
            <c:otherwise>
                <div class="col-12">
                    <div class="alert alert-info text-center" role="alert">
                        No hay guitarras Schecter disponibles en este momento.
                    </div>
                </div>
            </c:otherwise>
        </c:choose>
